...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    public AddCustomer() {
        ...
        ImageIcon image = new ImageIcon(ClassLoader.getSystemResource("flightreservationsystem/icons1/icons/emp.png"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            String query = "INSERT INTO passenger (name, nationality, aadhar, address, phone, gender, email) "
                    + "VALUES ('" + name + "', '"
                    + nationality + "', '"
                    + aadhar + "', '"
                    + address + "', '"
